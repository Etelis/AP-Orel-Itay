 ...
 */
void SimpleAnomalyDetector:: detector(vector<AnomalyReport>& reports, Point** points, const correlatedFeatures&  cp,
                                    size_t size) {
    Line reg = cp.lin_reg;
...
void SimpleAnomalyDetector::learnNormal(const TimeSeries& ts){
    ...
    // Run on all features detected best correlation and insert into the correlation vector.
