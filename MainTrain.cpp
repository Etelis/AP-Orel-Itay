...
//small test
int main(){
    STDtest std("C:\\Users\\Itay\\Desktop\\CS\\AP-Orel-Itay\\input.txt",
                "C:\\Users\\Itay\\Desktop\\CS\\AP-Orel-Itay\\output.txt");
    CLI cli(&std);
    cli.start();
    std.close();
    check("C:\\Users\\Itay\\Desktop\\CS\\AP-Orel-Itay\\output.txt","C:\\Users\\Itay\\Desktop\\CS\\AP-Orel-Itay\\expectedOutput.txt");
    cout<<"done"<<endl;
    return 0;
}
